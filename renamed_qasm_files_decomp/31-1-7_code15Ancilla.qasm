...
measure q[39] -> rec[98];
measure q[40] -> rec[99];
measure q[41] -> rec[100];
measure q[42] -> rec[101];
measure q[43] -> rec[102];
measure q[44] -> rec[103];
...
h q[44];
h q[45];
measure q[31] -> rec[120];
measure q[32] -> rec[121];
measure q[33] -> rec[122];
measure q[34] -> rec[123];
measure q[35] -> rec[124];
measure q[36] -> rec[125];
measure q[37] -> rec[126];
measure q[38] -> rec[127];
measure q[39] -> rec[128];
measure q[40] -> rec[129];
measure q[41] -> rec[130];
measure q[42] -> rec[131];
measure q[43] -> rec[132];
measure q[44] -> rec[133];
measure q[45] -> rec[134];
h q[31];
h q[32];
h q[33];
h q[34];
